...
public class GetListPlanService : ServiceBase<GetListPlanService, ProductDbContext, PaginatedRequest<PlanSearchRequest>, PaginatedResult<PlanDto>>, IGetListPlanService
{
    /// <summary>
    /// ctor
    /// </summary>
    ...
    public override async Task<PaginatedResult<PlanDto>> HandleAsync(PaginatedRequest<PlanSearchRequest> request, CancellationToken cancellationToken)
    {
        ...
        return await PaginatedResult<PlanDto>.SuccessAsync(result, totalCount, request.PageSize, totalCount);
    }
}