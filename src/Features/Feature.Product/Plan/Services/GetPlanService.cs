...
public class GetPlanService : ServiceBase<GetPlanService, ProductDbContext, long, Results<PlanDto>>, IGetPlanService
{
    /// <summary>
    /// ctor
    /// </summary>
    ...
    public override async Task<Results<PlanDto>> HandleAsync(long request, CancellationToken cancellationToken)
    {
        ...
        return await Results<PlanDto>.SuccessAsync(result);
    }
}