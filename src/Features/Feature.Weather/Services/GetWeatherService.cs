...
public class GetWeatherService : ServiceBase<GetWeatherService, WeatherDbContext, int, Results<GetWeatherResult>>, IGetWeatherService
{
    /// <summary>
    /// ctor
    /// </summary>
    ...
    public override async Task<Results<GetWeatherResult>> HandleAsync(int request, CancellationToken cancellationToken)
    {
        ...
        return await Results<GetWeatherResult>.SuccessAsync(item);
    }
}